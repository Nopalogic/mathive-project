			...
			<div className="container">
				<div className="block lg:flex">
					<div className="w-full pb-3 lg:mr-5 lg:w-1/2">
						...
						<p className="">
							Mathive merupakan website untuk belajar Matematika. Website ini dibuat dan dikembangkan agar teman-teman dapat belajar kalkulus dengan mudah. Selain untuk
							mempelajari kalkulus, website ini juga dibuat sebagai tugas besar mata kuliah kalkukus.
						</p>
					</div>
				...
				<p className="">
					Copyright &copy; 2023 All Rights Reserved by Nopalogic.
				</p>
			</div>
		</footer>
	);
